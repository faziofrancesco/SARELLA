    ...
    $.Calendario.prototype = {
        ...
        _getBody : function() {
            formatGoogleCalendar.init({
                calendarUrl: 'https://www.googleapis.com/calendar/v3/calendars/riuzaki9797@gmail.com/events?key=AIzaSyABCx7yk1fNMlkVDp9vf2r_7uLT_BEeFCA',
                past: false,
                upcoming: true,
                sameDayTimes: true,
                dayNames: true,
                ...
                upcomingHeading: '',
                pastHeading: '',    format: ['*date*', ': ', '*summary*', ' — ', '*description*', ' in ', '*location*'],
                timeMin: '2020-01-01T10:00:00-07:00',
                timeMax: '2020-12-31T10:00:00-07:00'
            });
            ...
            for ( var i = 0; i < 7; i++ ) {
                ...
                for ( var j = 0; j <= 6; j++ ) {
                    ...
                    var eventonew=today ?   '<ul id="events-upcoming"></ul>' : '';
                    if( content !== '' ) {
